...
# Ruta principal: muestra el formulario para ingresar los datos de conexión
...
# Ruta para mostrar las tablas de la base de datos si la conexión es exitosa
@app.route('/tablas')
def tablas():
...
# Ruta para mostrar los registros de una tabla seleccionada
